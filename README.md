...
npm install @eslint/js@9.37.0 @tailwindcss/vite@4.1.14 @types/axios@0.9.36 @types/humps@2.0.6 @types/node@24.7.0 @types/react-dom@19.2.1 @types/react-google-recaptcha@2.1.9 @types/react-router-dom@5.3.3 @types/react@19.2.2 @vitejs/plugin-react-swc@4.1.0 axios@1.12.2 dotenv@17.2.3 eslint-plugin-react-hooks@5.2.0 eslint-plugin-react-refresh@0.4.23 eslint@9.37.0 globals@16.4.0 humps@2.0.1 lucide-react@0.545.0 react-dom@19.2.0 react-google-recaptcha@3.1.0 react-router-dom@7.9.4 react@19.2.0 tailwindcss@4.1.14 typescript-eslint@8.46.0 typescript@5.9.3 vite@7.1.9
```
